...
DMP_VERSION="2.3.55"
DMP_ZIP_SHA256="af21961a9b4b96dba0cc54a50fcf579c7bfd3081c42605f7564751b09165841c"
...
unzip -p "$DMP_ZIP_PATH" '*direct-popup.js' | grep -F '自动归入该登录账号的默认店铺' >/dev/null || fail "达摩盘弹窗仍提示用户手动识别店铺"

...
EXPECTED_ZIP_SIZE_BYTES="3570541"
EXPECTED_ZIP_SHA256="adb3df18d6efea17dcb805efe616ce66e4ea2a014bfdc5fdd623386c7992b247"
...
[[ "$package_readme" != *"1.9.25"* && "$package_readme" != *"1.9.23"* ]] || fail "包内 README 仍含旧版本状态"

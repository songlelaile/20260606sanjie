...
const COLLECTOR = {
  name: "少壮AI自动化",
  version: "1.9.18",
  zipHref: "/downloads/sycm-keyword-collector-v1.9.18.zip",
  downloadName: "少壮AI自动化-v1.9.18.zip",
  sizeLabel: "约 3.1 MB",
...
const FEATURES = [
  ...
  {
    title: "编号主图视觉生产",
    desc: "严格按 L001、L002、L003 等链接编号读取定位、关键词、场景、差异化和核心文案；提示词先以单工位探路，成功后自适应扩到多工位，生图按每个编号、每张图独立并发，失败单图自动重试一次。"
  },
  {
    title: "编号详情页叙事生产",
  ...
  {
    title: "本地资产与三阶回流",
    desc: "关键词、排行、词根、链接清单、分类商品数据和图片结果优先保存在浏览器本地，可导出 Excel、CSV、JSON 或 ZIP；图片档案支持检索、预览、下载和 7 天回收站，经营源表还能回流三阶引擎继续诊断和看板复盘。"
  },
  {
    title: "安全边界与可控执行",
...
const RELEASE_NOTES = [
  "v1.9.18 将商品标题升级为两级精确 60 字符求解：先只使用热词榜完整词根，只有数学上无法达标时，才从当前链接已命中的市场排行商品标题中借鉴安全补齐词。",
  "市场标题借鉴会先剔除店铺名、品牌、进口与高端等待证表达、促销词、绝对化或功效风险词、商业禁用方向，以及不属于品类需求的纯字母数字词；借鉴不等于照抄。",
  "商品标题不再作为整条 AI 结果的前置硬门禁；标题缺失、过短、过长或白名单外时，仍保留营销企划、主图核心文案和详情文案等五个合格字段，由本地标题求解器重建。",
  "风格焕新完成后更换视觉或文案方案，会把旧图安全交接到本机成果档案，当前结果区立即恢复 0/N 空工位和新的开始生成按钮。",
  "主图、详情、案例裂变、风格焕新、批量 SKU 和引导重生的成功图片继续按账号自动进入本机成果档案，支持检索、预览、下载和 7 天回收站。",
  "v1.9.18 已完成 677/677 项自动化回归；ZIP 包内版本、压缩完整性、敏感文件排除和正式哈希均已核验，旧版下载与回滚目录继续保留。"
];

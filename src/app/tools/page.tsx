    ...
    <>
      ...
      <section className="tool-card">
        ...
        <p className="tool-lead">
          少壮AI自动化是一套围绕电商经营生产的工作台：先采集关键词与市场商品证据，拆解词根和真实需求，再结合商业目标与业务知识生成稳定的链接策略；商品标题由本地白名单求解器优先使用热词榜完整词根，在确实无法补齐 60 字符时才安全借鉴命中的市场标题。随后沿用同一商品身份、定位和证据，完成主图、详情页、批量 SKU 与爆款裂变的提示词和图片生产；成功图片按账号留存在本机成果档案。系统只读取当前账号可见数据，不修改网页业务数据，也不会让知识库或市场标题覆盖商品主体、品类锚点和真实证据。
        </p>
        ...
        <div className="tool-block">
          ...
          <article className="tool-usage-card" aria-labelledby="reference-detail-title">
            ...
            <div>
              ...
              <p>
                参考成详是一条独立生产线，不替代链接成详的 L 编号流程。从一个同行商品详情建立只读来源快照，系统自动整理 warning、fallback、partial 和可跳过的 blocked 模块；无需事实卡审核，上传已授权主体与可选模特后，一次锁定即可进入批量生成。
              </p>
            </div>
          </article>

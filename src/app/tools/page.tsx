...
const COLLECTOR = {
  name: "少壮AI自动化",
  version: "1.8.98",
  zipHref: "/downloads/sycm-keyword-collector-v1.8.98.zip",
  downloadName: "少壮AI自动化-v1.8.98.zip",
  sizeLabel: "约 2.8 MB",
...
const FEATURES = [
  {
    title: "经营数据采集与市场证据",
    desc: "从生意参谋采集关键词、相关词、市场商品榜和分日商品排行；没有生意参谋市场榜时，也可按淘宝销量采集 Top300 商品卡。v1.8.98 强化广告识别、成交语义与价格边界，减少真实商品误过滤和证据误算。"
  },
  {
    title: "词根、需求与商业任务",
  ...
  {
    title: "链接策略与规模化清单",
    desc: "将词根需求、市场证据和商业任务组合成稳定 L 编号，输出固定 20 字段链接上架清单；删除与确认采用串行写入，避免快速操作造成已删行复活或漏删，并以显式类目作为商品标题唯一品类锚点。"
  },
  {
    title: "AI 业务知识中枢",
  ...
  {
    title: "编号主图视觉生产",
    desc: "严格按 L001、L002、L003 等链接编号读取定位、关键词、场景、差异化和核心文案，结合商品主体多角度图逐条生成主图提示词并按编号生产，避免串号和主体漂移。"
  },
  {
    title: "编号详情页叙事生产",
    desc: "按每个链接的详情定位和文案逻辑生成连续分屏方案，以“问题—功能证据—用户利益—差异化—信任说明”组织说服顺序，并绑定商品多角度与可选模特素材。"
  },
  {
    title: "少壮图片实验室",
    desc: "批量查看淘宝商品主图，人工打标、分类和导出商品数据；可调用视觉与图片编辑 API 完成文字识别、翻译排版和整图除字，并保留原图、译图、除字图的原字节本地下载。"
  },
  {
    title: "SKU 与爆款裂变",
  ...
  {
    title: "参考流转、修复与拼接",
    desc: "原图、译图和除字图可一键流转到主图、详情、SKU 或裂变工作台；生成结果支持引导重生、局部改文案、主体修复、按选择顺序拼接主图或跨 L 组合详情长图。"
  },
  {
    title: "本地资产与三阶回流",
    desc: "关键词、排行、词根、链接清单、分类商品数据和图片结果优先保存在浏览器本地，可导出 Excel、CSV、JSON 或 ZIP；经营源表还能回流三阶引擎继续诊断和看板复盘。"
  },
  {
    title: "安全边界与可控执行",
...
const RELEASE_NOTES = [
  "v1.8.98 完成运营视角稳定性整改：链接清单删除与确认进入同一串行写队列，快速连续操作不再发生旧快照覆盖、已删行复活或静默漏删。",
  "市场证据保留“4人火锅、3人位沙发、5人份”等真实商品标题，扩大广告祖先识别，并补全已售、月销、销量等成交写法；价格与销量边界不清时按证据不足留空。",
  "显式类目成为商品标题唯一品类锚点；与源词其它品类冲突或缺少热词证据时明确阻断，不再生成“链接定位写 A 类目、标题写 B 类目”的错标商品。",
  "市场刷新空中间态不再清空旧榜，竞争分层、官方托管与自有网关并发上限按真实端点执行，遗留任务配置引用继续脱敏。",
  "主图、详情、SKU、案例裂变和风格焕新继续锁定当前商品主体与编号；主体任务、提示词、结果槽位和知识追溯保持独立、可恢复、可续跑。",
  "统一账号和多模型配置，关键结果优先保存在浏览器本地；v1.8.98 完成 633/633 项自动化回归。"
];
  ...
  return (
    <>
      <PageHeader
        eyebrow="AI Toolbox"
        title="AI 自动化工具"
        description="从经营数据到业务理解、链接策略、主图详情生产和本地交付的一体化 AI 工作台。少壮AI自动化 v1.8.98 把采集、分析、知识、企划与视觉生产连接成可追溯的完整流程。"
      />
      ...
      <section className="tool-card">
        ...
        <p className="tool-lead">
          少壮AI自动化是一套围绕电商经营生产的 Chrome 工作台：先采集关键词与市场商品证据，拆解词根和真实需求，再结合商业目标与业务知识生成稳定的 L 编号链接策略；随后沿用同一商品身份、定位和证据，完成主图、详情页、批量 SKU 与爆款裂变的提示词和图片生产。少壮图片实验室负责素材查看、标注、翻译、除字和参考流转，最终结果以 Excel、CSV、JSON 或 ZIP 保存在浏览器本地并可回流三阶引擎。系统只读取当前账号可见数据，不修改网页业务数据，也不会让知识库覆盖商品主体、词根和市场证据。
        </p>
